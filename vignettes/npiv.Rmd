...
title:
  formatted: "\\pkg{npiv}: Adaptive Estimation and Uniform Confidence Bands for Nonparametric Instrumental Variables Models Using \\proglang{R}"
  # If you use tex in the formatted title, also supply version without
  plain:     "\\pkg{npiv}: Adaptive Estimation and Uniform Confidence Bands for Nonparametric Instrumental Variables Models Using R"
  # For running headers, if needed
  short:     "\\pkg{npiv}: Adaptive Estimation and Uniform Confidence Bands for Nonparametric IV Models"
abstract: >
