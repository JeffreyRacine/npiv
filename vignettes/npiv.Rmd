...
author:
  - name: Timothy Christensen
    ...
    email: \email{t.christensen@ucl.ac.uk}
...
Nonparametric instrumental variables (NPIV) methods are well-established, widely used, and have been adopted by practitioners in a range of empirical fields. While there is a long tradition of their use in demand estimation in economics [@BCK; @BHP; @BerryHaile2014], NPIV methods have recently been adopted in causal inference in biostatistics [@WangZhiTT2018], reinforcement learning [@grettonRL2021], and causal machine learning [@causalML]. In this paper, we introduce the \proglang{R} package \pkg{npiv}. The package makes a novel set of estimation and inference methods for NPIV models, including with data-driven choice of tuning parameters, newly accessible to \proglang{R} users.
