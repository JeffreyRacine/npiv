...
\Plaintitle{\pkg{npiv}: Estimation and Confidence Bands for
Nonparametric Instrumental Variables Models Using R}
...
this paper, we introduce the \proglang{R} package \pkg{npiv}. The
...
accessible to \proglang{R} users.
