...
\Plainauthor{Jeffrey S. Racine, Timothy Christensen, Xiaohong Chen}
\Plaintitle{Estimation and Inference for Nonparametric Instrumental
Variables Models: The R Package \pkg{npiv}}
\Shorttitle{\pkg{npiv}: Estimation and Inference for Nonparametric
Instrumental Variables Models}


\Abstract{
Nonparametric instrumental variables (NPIV) methods are widely used for
causal inference in economics and have been adopted in other fields
including machine learning, by way of illustration. This article
...
for constructing (non-data driven) nonparametric uniform confidence
bands based on the methods proposed in \citet{CCQE}. All methods subsume
standard nonparametric regression as a special case.
}
...
\pkg{npiv} in the data frame \texttt{Engel95}.
