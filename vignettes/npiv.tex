...
across economics, causal inference, and machine learning. This article
...
\citet{CCK}. The main methods implemented in this package are (i) a
data-driven, rate-optimal choice of sieve dimension for sieve NPIV
...
methods proposed in \citet{CCQE}. All methods apply to nonparametric
...
description of the main functionality of the package \pkg{npiv} and
