...
manner using two-stage least-squares (TSLS) \citep{AC, NP}. The main
methods implemented in \pkg{npiv} are (i) a data-driven choice of sieve
dimension for sieve NPIV estimators and (ii) data-driven uniform
confidence bands (UCBs) for the structural function \(h_0\) and its
derivatives. As shown in \citet{CCK}, the single data-driven choice of
sieve dimension is minimax sup-norm rate adaptive for estimating both
