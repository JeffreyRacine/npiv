...
\Plainauthor{Timothy Christensen, Jeffrey S. Racine, Xiaohong Chen}
...
for constructing uniform confidence bands for the structural function
and its derivatives based on the methods proposed in \citet{CCQE}. All
...
this paper, we introduce the \proglang{R} \citep{R} package \pkg{npiv}
...
parameters, thereby making the methods newly accessible to \proglang{R}
users. The package \pkg{npiv} is available from the Comprehensive R
