...
npivJ <- function(Y,
    ...
    for(ii in 1:NROW(J1.J2.x)) {
        ...
        for(b in 1:boot.num) {
            ...
            beta.J1.boot <- .lm.fit(t(Psi.xJ1TB.wB.wTB.w.invB.w), U.J1*boot.draws)$coefficients
            beta.J2.boot <- .lm.fit(t(Psi.xJ2TB.wB.wTB.w.invB.w), U.J2*boot.draws)$coefficients
